...
# loading_circles = wait.until(EC.invisibility_of_element_located((By.ID, "preloader-animated_svg__circles3")))
#
# title_abc = driver.find_element(By.XPATH, "//span[text()='ABC SHOWS, SPECIALS & MORE']")
# assert 'SPECIAL' in title_abc.text, 'the text not present'
#
# print('working fine')
# driver.quit()
